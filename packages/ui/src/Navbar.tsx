...
const Navbar = ({ children }: { children: React.ReactNode }) => {
  ...
  return (
    <div>
      <motion.div initial={{ opacity: 0, y: -100 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 5.0, ease: "easeOut" }}  className="flex h-20 items-center justify-center shadow-lg shadow-indigo-500/50">
